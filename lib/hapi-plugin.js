 ...
 *            <ul>
 *            <li>proxy - REQUIRED - which will be used to configure a route as
 *            proxy in Hapi - see
 *            http://spumko.github.io/resource/api/#server-route-options-
 *            <li>path - (optional) the absolute path used to match incoming
 ...
 *            in Path parameters. Default is
 *            '/api/runrightfast-logging-service/log'.
 *            </ul>
 * 
 * 
 * Default propxy options are the same as Hapi, except for those listed below:
 * <code>
 *    	options = {
 *    		proxy : {
 *    			xforward : true,
